...
const GAME_DATA = {
  ...
  evidence: {
    // 第一章 s1_1（1842年 虎門炮台）
    e_wounded_soldier: { name: "受傷清兵", category: "時代背景", content: "「洋人的槍一響——」傷兵停了停，腿上的繃帶又滲出一道血色，「我的盾還沒舉起來。炮台沒了，**我們連跑的力氣都沒有**。」——虎門守兵口述，1842 年 6 月。",
      inference: {
    ...
    e_british_officer_1842: { name: "英軍士官", category: "時代背景", content: "「中國的炮台如此原始，我們幾乎感到不忍。他們的勇氣是真實的，但武器是另一個時代的。」——英國海軍士官私人日記，1842年。對等的勇氣，不對等的武器。" },
    e_iron_cannon_ruins: { name: "清代舊式鑄鐵炮殘件", category: "時代背景", content: "鑄於乾隆五十年的青銅前膛炮——「龍威將軍」字樣已被海風剝蝕大半。射程三百碼，彈道平直，無法仰角。對面英艦尚在六千碼外，這門炮便已啞了。**它不是壞了，是過時了八十年**。",
      inference: {
    ...
    e_british_musket_1842: { name: "英軍燧發槍殘件", category: "時代背景", content: "英軍1840年代配備的褐貝斯燧發槍，雖非最新型，射程已達二百碼，可連射。清軍裝備仍以弓箭、刀槍、舊式火繩槍為主——一場以冷兵器對抗工業革命的戰爭，勝負早已注定。" },
    e_nanjing_treaty_draft: { name: "《南京條約》草稿", category: "時代背景", content: "1842 年 8 月 29 日，「皋華麗號」艦上。中文文本以工楷謄寫，朱印鮮紅：割香港、賠二千一百萬銀元、開五口、廢公行。**第一個不平等條約**——這份手稿，是百年屈辱的開頭一頁。",
      inference: {
    ...
    e_mongolian_cavalry: { name: "倒地的蒙古騎兵", category: "時代背景", content: "1860 年 9 月 21 日午後，八里橋。三萬蒙古鐵騎衝鋒——五人陣亡。聯軍代價：**陣亡五人**。倒下的騎兵手中仍緊握著弓，但弓已不夠用了。一個時代的結束，只用了三個小時。",
      inference: {
    ...
    e_cavalry_saber: { name: "蒙古騎兵彎刀", category: "時代背景", content: "蒙古騎兵配備的傳統彎刀，工藝精湛，近身格鬥無匹。然阿姆斯特朗炮有效射程逾三千碼，騎兵在達到有效衝鋒距離之前，已在炮火中損失過半——冷兵器在現代炮火面前，勇氣與技術皆無從發揮。" },
    e_armstrong_shell: { name: "阿姆斯特朗炮炮彈殼", category: "時代背景", content: "黃銅彈殼，3 英寸口徑，膛線清晰可見。**阿姆斯特朗 6 磅後膛炮**，1855 年研發——射程逾三千碼，每分鐘三發。八里橋戰場上，清軍甚至沒有走到弓箭的有效射程。",
      inference: {
    ...
    e_beijing_treaty_1860: { name: "《北京條約》停戰通牒", category: "時代背景", content: "1860年10月簽訂，清廷被迫增開通商口岸，賠款增至一千六百萬兩，割讓九龍半島，允許外國公使駐京，開放華工出洋。英法聯軍入侵北京，咸豐帝北狩熱河，圓明園付之一炬——京師淪陷，天朝體制徹底崩塌。" },
    e_wenxiang_notes: { name: "文祥隨軍筆記殘頁", category: "時代背景", content: "「夷情萬難禁絕……非通其情、習其長技，不足以制之。今京師震動，吾輩**坐而論道，已無寸進之機**。」——文祥（滿洲正紅旗人，時任軍機大臣）於八里橋戰敗後私記，1860 年 9 月。一年後，他與奕訢上奏設立總理衙門——**洋務運動由此啟動**。\n\n硝煙之下這片殘頁，是失敗者的反思，也是改革的種子。",
      inference: {
    ...
    e_hanlin_scholar: { name: "翰林院學士", category: "時代背景", obstacle: true, content: "「八股取士，乃選拔忠良之根本；科舉廢則人心散，人心散則天下亂。西學或有其用，然若動搖制度根基，後患無窮——此乃我等翰林之職責，寸步不讓。」——翰林院學士語，1861年。" },
    e_haiguo_tuzhi: { name: "《海國圖志》", category: "時代背景", content: "魏源 1843 年撰，百卷。卷首一句——「**師夷之長技以制夷**」。此書在日本流傳極廣，催生了明治維新；在清廷被斥為奇談，束之高閣。十八年後，當奕訢翻開它的時候，已晚了一個世代。",
      inference: {
    ...
    e_jiao_bin_lu: { name: "《校邠盧抗議》", category: "時代背景", content: "馮桂芬1861年撰，提出「以中國倫常名教為原本，輔以諸國富強之術」，即後來「中學為體、西學為用」的最早表述。主張設翻譯館、派留學生、學習西方科技，但明確以儒家倫理為根基，試圖消解守舊派的顧慮。" },
    e_taiping_report: { name: "太平天國奏報", category: "時代背景", content: "1851年洪秀全金田起義，1853年建都天京（南京），勢力席捲半壁江山。清廷正規軍八旗、綠營皆無力抵禦——最終依靠曾國藩湘軍、李鴻章淮軍，並借助常勝軍洋槍洋炮，方才於1864年平亂。西式武器的實效，在這場平亂中得到最有力的證明。" },
    e_ever_victorious_report: { name: "常勝軍戰報", category: "時代背景", content: "美國人華爾編，英國人戈登續：常勝軍蘇州一役，**斃敵八千，自損二十**。戰報每頁皆附傷亡比。曾國藩讀完，於奏摺旁批：「洋槍洋炮之利，不可不察。」這份戰報，成為洋務最早的數據佐證。",
      inference: {
    ...
    // 第二章 s2_1（1861年 總理衙門）
    e_western_diplomat_1861: { name: "等候的西洋外交官", category: "前期強兵", subCategory: "外交政治", content: "「中國人終於設立了一個可以正式交涉的機構。」——1861 年駐華英國外交官私函。「在此之前，我們連對口部門都找不到。**條約需要執行，爭端需要解決——卻沒有人負責**。」總理衙門的設立，是一個遲來但重要的開始。",
      inference: {
    ...
    e_zongli_globe: { name: "西洋地球儀", category: "前期強兵", subCategory: "外交政治", content: "西洋黃銅地球儀，赤道圈刻度精細，五大洲各有色彩。1861 年總理衙門購入時，奕訢凝視許久——**「中國」二字，竟然只是球面上的一塊**。從這一刻起，「天朝」二字第一次有了裂縫。",
      inference: {
    ...
    e_diplomatic_box: { name: "紅木外交文件盒", category: "前期強兵", subCategory: "外交政治", content: "紅木鎏金，內襯黃綢。盒中堆疊著各國照會、條約副本、外交備忘錄——層層疊疊，墨蹟新舊不一。從前禮部用一紙折子打發的「夷務」，如今竟需要一個衙門來收存。**從「夷」到「洋」**，差的就是這個盒子。",
      inference: {
    ...
    e_foreign_sphere_map: { name: "列強在華勢力地圖", category: "前期強兵", subCategory: "外交政治", content: "1862 年繪。英（紅）佔長江流域、華南；俄（藍）扎東北、新疆；法（黃）覆雲南、越南；德（綠）伸山東。**色塊已侵入腹地**——中國若不主動外交，剩下的白色也會被瓜分。這張地圖，是總理衙門存在的最有力理由。",
      inference: {
    ...
    e_burlingame_records: { name: "蒲安臣使團記錄", category: "前期強兵", subCategory: "外交政治", content: "1867 年奕訢以美國外交官蒲安臣（Anson Burlingame）為首席使節。使團出訪英、美、法、德、俄五國。成果：**美國暫緩修約，列強承認中國自主改革權**。這是中國外交主動出擊的第一次成功。",
      inference: {
    ...
    e_john_fryer: { name: "傅蘭雅（John Fryer）", category: "後期富國", subCategory: "改革教育", content: "「我譯《汽機發軔》、《化學鑑原》——不是讓中國人崇拜西學，**而是讓他們能自行閱讀、自行改良**。當一個中國工人能照我的圖紙獨立操作蒸汽機，那一刻，知識才真正屬於中國。」——傅蘭雅，江南譯書館主任，在華 31 年。",
      inference: {
    ...
    e_bilingual_manual: { name: "中西對照技術藍圖", category: "後期富國", subCategory: "改革教育", content: "左頁英文：valve、piston、cylinder。右頁中文：閥、活塞、汽缸。每個術語都是傅蘭雅與徐壽、華蘅芳一字一字商定的。**一個工人不必懂英語，也能讓蒸汽機轉動**——這就是「師夷長技」最具體的實踐。",
      inference: {
    ...
    e_steam_gear: { name: "蒸汽機核心齒輪", category: "前期強兵", subCategory: "軍事工業", content: "黃銅鑄造，齒紋精細到絲毫不差。1865 年江南局自製成功的第一組蒸汽機核心。從前安慶軍械所要四個工匠搖動曲柄才能驅動的事，如今**一台機器自己會做**。中國工業革命，從這組齒輪開始。",
      inference: {
    ...
    e_cannon_barrel: { name: "半完成的炮管", category: "前期強兵", subCategory: "軍事工業", content: "後膛裝彈、線膛旋轉、口徑 4 英寸——半完成的炮管尚未拋光，膛線在燭光下閃爍。1867 年江南局首批自製。**從安慶土法到江南機器**，中國軍工跨過了整整一個世代——只用了六年。",
      inference: {
    ...
    e_coal_iron: { name: "煤鐵原料", category: "前期強兵", subCategory: "軍事工業", content: "「船炮機器之用，非鐵不成，非煤不濟。」——李鴻章。煤與鐵是工業化的兩大基石，江南局的每門炮、每艘船皆從此開始。這也是日後富國措施（開礦、鐵廠）的根本動因。" },

    // 第二章 s2_3（1870年 天津練兵場）
    e_foreign_military_advisor: { name: "外籍教官", category: "前期強兵", subCategory: "編練新軍", content: "「中國士兵的勇氣是真實的——他們在八里橋拿著彎刀衝炮兵陣地，這需要比任何西方士兵更大的勇氣。」——某英籍教官訓練日誌，1870 年。「**問題不是勇氣，是系統**。給他們恩菲爾德、教他們散兵線——三個月後，我已無需再擔心。」",
      inference: {
    ...
    e_enfield_rack: { name: "恩菲爾德步槍架", category: "前期強兵", subCategory: "編練新軍", content: "英製 1853 式恩菲爾德步槍，膛線旋轉，**有效射程 500 碼**。八旗弓箭最遠 80 碼。一架槍架擺著二十支——這就是淮軍訓練營的常規裝備。一場仗還沒開始，輸贏已在槍架上寫好。",
      inference: {
    ...
    e_formation_manual: { name: "西式陣法操練圖", category: "前期強兵", subCategory: "編練新軍", content: "圖冊由戈登繪製，中英對照。左頁畫散兵線陣形：兵與兵相距三步，火力交錯覆蓋。右頁畫舊式衝鋒陣：密集前進，**一輪炮火可斃整列**。圖示之下，戈登只寫了一句：「Old way: heavy losses.」",
      inference: {
    ...
    e_gordon_journal: { name: "戈登訓練日誌", category: "前期強兵", subCategory: "編練新軍", content: "中英雙語訓練日誌，逐月記錄。第三個月：**淮軍射擊精準度達英軍標準八成**。第六個月：能獨立執行散兵戰術。戈登批註：「他們學得比我預期快。」這份日誌，後來成為李鴻章奏議裡最具份量的數據附件。",
      inference: {
    ...
    e_target_board: { name: "木製射擊靶標", category: "前期強兵", subCategory: "編練新軍", content: "木製靶板，圓心三環，彈孔密集如蜂巢——尤其在十環內，幾乎連成一片。淮軍恩菲爾德步槍訓練第三個月成果。**舊式鳥槍能擊中靶心一發已是難得**。一塊木板，比千言萬語都更能說服朝廷。",
      inference: {
    ...
    e_yung_wing: { name: "容閎", category: "後期富國", subCategory: "改革教育", content: "「余以為，欲強中國，必先教育人才。吾在耶魯十五年，從未忘記自己是中國人；我選出的一百二十名學童，也不會。他們學成後帶回的，不只是工程與法律的知識，而是一種信念：中國人能做到，與洋人一樣好。」——容閎，首批留美學童選拔完成後，1872年。" },
    e_english_chart: { name: "英文課程教學掛圖", category: "後期富國", subCategory: "改革教育", content: "教學掛圖，左欄英文字母，右欄漢字音譯。1862 年京師同文館首開英文課，**中國第一所系統教授西方語言的官辦學堂**。從前所有條約簽訂都倚賴洋人翻譯——往往中國因此吃虧。同文館的存在，是為了讓中國能自己讀懂條約。",
      inference: {
    ...
    e_students_roster: { name: "留美學童官方名冊", category: "後期富國", subCategory: "改革教育", content: "1872 年首批留美學童名冊，120 人。年齡 9-15 歲。前十名中，有**詹天佑**（日後京張鐵路總工程師）、**唐紹儀**（民國首任國務總理）。這份名冊，是中國近代化人才庫的起點。",
      inference: {
    ...
    e_sextant: { name: "銅製六分儀", category: "後期富國", subCategory: "改革教育", content: "黃銅六分儀，可測天體高度與經緯度。同文館課程涵蓋算學、天文、化學、測量——**用儀器看世界**，比四書五經更接近「實學」二字。學生第一次親手測出太陽高度時，那一刻，他們便不再是傳統的儒生。",
      inference: {
    ...
    e_xutong_impeach: { name: "徐桐彈劾留學奏議", category: "時代背景", obstacle: true, content: "「夷學害道——幼童赴美，吃洋食、穿洋衣、學洋語、信洋教，**歸來者已非華人**。臣懇請朝廷立即停止派遣，召回學童，以正人心、護道統。」——徐桐（翰林院掌院學士）彈劾留學計劃奏議節錄。1881 年留學計劃中斷召回，**徐桐之言實為主因之一**。\n\n洋務尚在啟動，反對的力量已經集結——這份奏議，是洋務初期最早的陰影。",
      inference: {
    ...
    // 第三章
    e_brass_ship_model: { name: "黃銅招商局輪船縮模", category: "後期富國", subCategory: "興辦實業", content: "黃銅鑄造的招商局輪船縮模，船身刻有「**輪船招商局**」六字。1873 年成立，向洋行購入第一批輪船，正式以「官督商辦」形式經營沿海航運。怡和、太古的鐵甲船霸權，第一次有了競爭者。" },
    e_shipping_route_map: { name: "上海至天津航線掛圖", category: "後期富國", subCategory: "興辦實業", content: "牆掛航線地圖，紅線標出招商局的航線：上海—天津、上海—廣州、長江內河。1878 年數據：**招商局已奪回長江航運的三成份額**。怡和的運費——首次被迫下降。",
      inference: {
    ...
    e_foreign_shipping_rates: { name: "洋商壟斷運費帳目", category: "後期富國", subCategory: "興辦實業", content: "怡和輪船公司 1872 年帳目影本：上海至天津，每擔運費三錢二分。中國商人可負擔的水準：每擔二錢——**整整高出五成**。利權外流不是抽象詞彙，是每船貨、每年數十萬兩白銀的具體流失。",
      inference: {
    ...
    e_zhaoshang_first_report: { name: "招商局創辦五年成效報告", category: "後期富國", subCategory: "興辦實業", content: "唐廷樞 1878 年向李鴻章呈報：**五年內購入輪船十六艘，年節省運費逾百萬兩**，怡和、太古被迫降價。報告末頁，李鴻章硃批四字——「**官督商辦**，可行」。這四字，啟動了洋務後期所有民用工業。",
      inference: {
    ...
    e_morse_telegraph: { name: "摩斯電報機", category: "後期富國", subCategory: "興辦實業", content: "黑色木匣，黃銅電鍵，旁置長條紙帶。1881 年 12 月 28 日，盛宣懷按下天津至上海的第一份電報——**「萬古一日」**四字傳到南方。從信差三十日到電流三分鐘，**中國的時間第一次被壓縮**。",
      inference: {
    ...
    e_railway_spike: { name: "鐵路道釘", category: "後期富國", subCategory: "興辦實業", content: "鑄鐵道釘，鏽蝕略可見。1881 年唐胥鐵路（唐山—胥各莊）所用，**全長 9.7 公里，中國第一條自建鐵路**。為避朝廷忌諱，初期以騾馬牽引，後悄悄換上蒸汽機車。一枚道釘的長度，是中國鐵路網的起點。" },
    e_taiwan_delay_1874: { name: "1874年台灣防務電報延誤記錄", category: "後期富國", subCategory: "興辦實業", content: "1874 年 5 月 17 日，朝廷檔案：日軍登陸台灣，**消息傳到京師耗時三十二日**——當朝廷知道時，事已四十日。這份延誤檔案，是李鴻章力主建設電報網絡最核心的論據。**防務之痛，是現代化的最大動力**。",
      inference: {
    ...
    e_submarine_cable_map: { name: "天津至上海海底電線鋪設圖", category: "後期富國", subCategory: "興辦實業", content: "1883 年鋪設示意圖：天津—煙台—上海—廣州—香港。1885 年 3 月，法軍進犯台灣，**清廷二十分鐘內得報**——比 1874 年快了八萬六千四百倍。一條銅線，重塑了戰時情報的地理。",
      inference: {
    ...
    e_iron_ingot: { name: "鑄鐵錠", category: "後期富國", subCategory: "興辦實業", content: "1894 年漢陽鐵廠首批鑄鐵錠，重約十斤，編號「漢一」。**中國首次以本土煤鐵自鑄出符合工業標準的鋼鐵**。從前要從洋商買到的鐵，如今從大冶礦坑、開平煤礦、漢陽高爐這條鏈出來。",
      inference: {
    ...
    e_daye_ore_sample: { name: "大冶礦石樣本", category: "後期富國", subCategory: "興辦實業", content: "大冶鐵礦礦石樣本，鐵含量高達六成五。1891年大冶鐵礦正式開採，為漢陽鐵廠提供穩定原料——開平出煤、大冶出鐵、漢陽冶煉，形成中國第一條完整煤鐵產業鏈。" },
    e_hanyang_blueprint: { name: "漢陽鐵廠高爐設計圖", category: "後期富國", subCategory: "興辦實業", content: "藍紙白線，標明三座**五十噸日產量**的煉鋼高爐。張之洞 1888 年籌建，1894 年投產——**中國最大的鋼鐵聯合企業**。配合大冶鐵礦與開平煤礦，是「煤鐵自給」這四個字最具體的形狀。",
      inference: {
    ...
    e_kaiping_production: { name: "開平礦務局年度產量報告", category: "後期富國", subCategory: "興辦實業", content: "唐廷樞 1881 年至 1891 年產量報告：**從 3,000 噸增至 250,000 噸**——十年八十倍。煤炭供應北洋艦隊與唐胥鐵路。這串數字，是抗擊「洋務無用論」最有力的反駁。",
      inference: {
    ...
    e_sand_table: { name: "戰術沙盤", category: "後期富國", subCategory: "改革教育", workshopExclude: true, content: "帆布軍帳內的沙盤，標記山丘、河流、橋梁。錫製小兵分敵我兩色，黃銅指揮棍擱在旁邊。1885 年武備學堂從普魯士引進——**戰術從口頭講解變成可視化推演**。學員們第一次看見「地形」這個概念，是立體的。",
      inference: {
    ...
    e_rangefinder: { name: "測距儀", category: "後期富國", subCategory: "改革教育", workshopExclude: true, content: "黃銅炮兵測距儀，木製三腳架。鏡片 19 世紀末德國工藝。**炮兵不再憑經驗估距——而是以數學測得**。武備學堂課程因此必修代數、三角。從此，「軍人需懂科學」這六個字，有了具體形狀。",
      inference: {
    ...
    e_german_artillery_chart: { name: "德文克虜伯炮術掛圖", category: "後期富國", subCategory: "改革教育", workshopExclude: true, content: "德文掛圖，1882 年克虜伯炮術圖解：**炮管剖面、彈道拋物線、仰角換算表**。每一行字下，學員都用毛筆抄寫中文翻譯。從買炮到造炮、從用炮到懂炮——**整套引進普魯士軍事體系**，是制度西化最大膽的一步。",
      inference: {
    ...
    e_wubei_roster: { name: "學員名冊", category: "後期富國", subCategory: "改革教育", content: "武備學堂學員名冊，每頁五人。各省保薦，年齡 18-25。其中**段祺瑞、馮國璋、王士珍**——日後北洋三傑，皆出此處。一冊名單，是中國近代軍官的搖籃。" },

    // 第三章 人物
    e_tang_tingzhu: { name: "唐廷樞", category: "後期富國", subCategory: "興辦實業", content: "「怡和、太古二洋行壟斷航運三十年……五年下來，洋商主動降價三成——不是因為他們仁慈，是因為他們知道，我們已是真正的競爭對手。」——唐廷樞，輪船招商局首任總辦，1878年。唐廷樞本為買辦，卻以洋行經驗反過來與洋行競爭，是洋務富國中商業本土化的最佳典範。" },
    e_sheng_xuanhuai: { name: "盛宣懷", category: "後期富國", subCategory: "興辦實業", content: "「一八七四年，日本兵船逼台，消息遲三十日始達北京……電報不是奢侈，是生死之速。」——盛宣懷，南北洋電報總局督辦，1881年。盛宣懷主持建設天津至上海電報線，又監督唐胥鐵路工程，是官督商辦體制下最成功的洋務實務官員之一。" },
    e_zhang_zhidong: { name: "張之洞", category: "後期富國", subCategory: "興辦實業", content: "「洋人的炮是鋼鐵鑄的……若不能自給鋼鐵，洋務永遠只是替洋人做嫁衣。」——張之洞，湖廣總督，1894年。張之洞以漢陽鐵廠為核心，試圖建立中國完整的煤鐵工業鏈，提出「中學為體、西學為用」，是晚清洋務思想的最後一位重量級倡導者。" },
    e_german_instructor: { name: "德國教官", category: "後期富國", subCategory: "改革教育", content: "「普魯士在1870年以炮術和參謀制度打敗法國，靠的是精確計算和統一指揮……問題是，你們的將帥願意讓他們用嗎？」——天津武備學堂德國教官，1888年。這句反問，道出洋務軍事改革的根本困境：器械可引進，制度能否真正改變？" },

    // 第四章
    e_woren_person: { name: "倭仁", category: "時代背景", obstacle: true, content: "「立國之道，尚禮義，不尚權謀；根本之圖，在人心，不在技藝……設若人心盡失，縱有洋炮千門，亦守不住中國！」——倭仁，大學士、理學領袖，1867年上書反對同文館增設算學科。倭仁代表清廷中堅的道學守舊派，其反對並非無知，而是對文化本位的深切執著。" },
    e_woren_memorial: { name: "倭仁奏摺", category: "時代背景", obstacle: true, content: "倭仁《請罷同文館天文算學館折》（1867）。核心兩句：「**立國之道，尚禮義，不尚權謀；根本之圖，在人心，不在技藝**。」此摺以儒家道統為盾，是守舊派最具影響力的論述。它沒能阻止算學館成立，卻奠定了反洋務的理論基礎。",
      inference: {
    ...
    e_naval_fund_diverted: { name: "三千萬軍費挪用奏摺", category: "時代背景", obstacle: true, content: "1894 年 3 月，奏摺殘卷：「**海軍經費移撥工程**」八字，硃印赫然。三千萬兩白銀——本應為北洋更新十年的軍備——流入頤和園的湖石與琉璃。日本同期海軍預算逐年遞增，**雙方此消彼長**。",
      inference: {
    ...
    e_japan_naval_budget: { name: "日本海軍軍費擴張比較表", category: "時代背景", obstacle: true, content: "比較表（外務省檔案，1894）：**日本 1880 年海軍預算 800 萬日元，1894 年 1,800 萬——逐年遞增**。中國北洋同期：**1888 年成軍，1894 年仍未更新**。一張表格，比千言萬語都更說明甲午為何必敗。",
      inference: {
    ...
    e_beiyang_aging: { name: "北洋艦隊生鏽炮彈殼", category: "時代背景", obstacle: true, content: "**北洋艦隊鐵甲艦明細（1894）**：定遠、鎮遠——1881 年下水，已 13 年；致遠、靖遠——1887 年，7 年。**沒有一艘是 1888 年成軍後新造的**。海軍科技每五年一代，北洋已老了三代。生鏽的炮彈殼，只是表象。",
      inference: {
    ...
    e_lilianying_person: { name: "李蓮英", category: "時代背景", obstacle: true, content: "「太后的壽辰，是天下的大事……太后高興，皇上才安心，朝廷才穩定。」——李蓮英，慈禧貼身太監，1888年。（據史料情境重構）李蓮英實際掌握太后起居一切，頤和園工程由其監管，軍費挪用的細目亦經其手核准——宮廷腐敗的樞紐，往往是這些看似低微的角色。" },
    e_summer_palace_marble: { name: "頤和園大理石建材方塊", category: "時代背景", obstacle: true, content: "石舫（清晏舫）所用漢白玉大理石方塊，採自房山。頤和園1888年重建，耗費約三千萬兩，全數來自本應撥給北洋水師的軍費。這艘永遠停泊的石舫，以船的外形，用海軍的錢建造，卻永遠無法出海——洋務三十年的最大悲劇，莫過於此。" },
    e_provincial_navy: { name: "各省水師分布掛圖", category: "時代背景", obstacle: true, content: "各省水師分布掛圖（1894）：**北洋、南洋、福建、廣東——四支艦隊，四個總督，四套指揮系統**。從未真正合一。中央想統一，地方不放權；戰時各艦各艦，各自為政。這張圖，是制度問題的縮影。",
      inference: {
    ...
    e_nanyang_refuse: { name: "南洋拒援電報", category: "時代背景", obstacle: true, content: "1894 年 9 月 17 日，南洋艦隊覆電北洋：「**非我所轄**。」四個字，墨蹟新鮮。電報紙下，是丁汝昌跪在指揮室地上的身影。**洋務三十年建了艦隊，卻沒建成一支海軍**——四個字，道盡這一切。",
      inference: {
    ...
    e_yixin_proposal: { name: "奕訢增設西學章程", category: "後期富國", subCategory: "改革教育", content: "1867 年奕訢《同文館增設天文算學館章程》：「**天文算學，非奇技淫巧，乃富強之根本**。」奏摺主張選拔翰林進士入館學習科學——這是改革派挑戰守舊派最大膽的一次嘗試。最終獲准，但代價慘重。",
      inference: {
    ...
    e_tongwenguan_textbook: { name: "同文館洋文教科書", category: "後期富國", subCategory: "改革教育", content: "同文館教材：《幾何原本》（徐光啟譯）、《代微積拾級》（李善蘭譯）。**三角函數表、幾何證明、微積分入門**——清廷子弟第一次接觸到「實證」式學問。教材是制度的具體化，沒有它，西學只能停留在空談。",
      inference: {
    ...
    e_keju_exam: { name: "科舉八股試卷", category: "時代背景", obstacle: true, content: "清代八股取士的標準試題，規定格式：破題、承題、起講、入手、起股、中股、後股、束股，字數嚴格，不得逾矩。倭仁等守舊派認為此制度選拔忠正賢良，是治國根本。然而批評者指出，八股制度令士子只會詞章，不能應對外患——洋務所需的數學、工程、語言，全不在考試之列。科舉與洋務，是兩套根本上互不相容的知識體系。" },
    e_ding_ruchang: { name: "丁汝昌遺書", category: "時代背景", obstacle: true, content: "「汝昌決計以死報國……今日非汝昌所能救，非一人之力，乃制度積弊之必然。北洋之設備，南洋之不援，朝廷之挪用——吾等以血肉之軀，填制度之窟，豈有勝算？」——丁汝昌，北洋水師提督，1895年2月威海衛陷落後服毒自盡。其遺書既是對三十年洋務的沉痛總結，也是對整個體制的最後控訴。非為失敗而死，而為制度性悲劇殉節。" },
    e_sand_shells: { name: "沙土填充炮彈殼", category: "時代背景", obstacle: true, content: "黃海戰場拾獲，重量比真彈輕了三成——剖開：**沙土填充，無爆炸藥**。產自天津機器局，由克虜伯彈藥司「監造」。一發炮彈的造價，被驗收官員、軍火承辦商、地方衙門層層剋扣。**敗於日本之前，洋務已敗於自己**。",
      inference: {
    ...
    e_signal_flag: { name: "北洋旗艦信號旗殘件", category: "時代背景", obstacle: true, content: "黃海海戰中，定遠艦（旗艦）桅桿被日艦炮火擊斷，指揮信號旗無法懸掛，各艦失去統一號令，各自為戰。這面破損的信號旗，是北洋水師指揮體系崩潰的縮影——硬體上領先，但一旦指揮中斷，各省各艦便各自逃散。三十年建軍的成果，瞬間化為烏有。洋務建了艦船，卻未建成統一指揮的海軍體制。" },

    // ── Phase 2 新增：分支獎勵 evidence（僅在前面決策選 B 時解鎖） ──
    e_wei_yuan_note: { name: "魏源遺稿殘頁", category: "時代背景", content: "魏源《海國圖志》初版手稿殘頁，墨跡仍存批註：「夷之長技三：一戰艦，二火器，三養兵練兵之法。為以夷攻夷而作，為以夷款夷而作，為師夷長技以制夷而作。」——魏源，1842年。在八里橋戰場一隅拾得這頁手稿，恍如歷史伏筆：十八年前已有人寫下答案，卻無人聽從。" },
    e_zongli_doc: { name: "總理衙門公文夾", category: "前期強兵", subCategory: "外交政治", content: "總理衙門 1872 年諭令：**「西方操典譯印分發各營」**。這份公文意味著新式練兵已不是地方獨斷，而是中樞既定之策。地方守舊派若仍守舊式，便是違中樞之命。" },
    e_zhaoshang_ledger: { name: "招商局營收簿冊", category: "後期富國", subCategory: "興辦實業", content: "招商局光緒四年（1878）營收明細：航運盈餘四十二萬兩、保險業務十八萬兩、棧房租金九萬兩，總計逾七十萬兩，較上年增三成。簿冊末頁附唐廷樞批註：「商辦之效，賬冊自言。若官府不過度干預，五年內可全面取代洋商。」——一本帳冊，是「官督商辦」最有力的辯護。" },
    e_fugue_ce: { name: "丁韙良《富國策》譯本", category: "時代背景", obstacle: true, content: "「國家之強弱，不在器物之精粗，而在制度之良窳。鐵船無千萬之功，憲法有億兆之效。」——丁韙良譯《富國策》（Henry Fawcett 原著），同文館 1880 年印行。丁韙良為美國傳教士、同文館總教習，譯介西方政治經濟學著作。此書的存在本身，已說明清廷部分官員早已知道：自強的真正關鍵不在槍炮，而在制度。然此書傳閱有限，慈禧未及閱卷一頁。" }
  }
};
